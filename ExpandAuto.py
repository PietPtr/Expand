...
movingTransmitter = Transmitter([0, 500])
direction = 1
...
while True:
    ...
    if movingTransmitter.position[0] > 1800:
        direction = -1
    elif movingTransmitter.position[0] < 0:
        direction = 1
    movingTransmitter.spawn()
    movingTransmitter.position[0] += direction
